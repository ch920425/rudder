...
export const help: Record<string, string> = {
  ...
  countSubscriptionUsageAsCost: "For Codex subscription login runs, estimate API-equivalent spend from token usage. Leave off to record subscription runs as $0.",
