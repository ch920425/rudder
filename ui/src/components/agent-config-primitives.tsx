...
export const help: Record<string, string> = {
  ...
  countSubscriptionUsageAsCost: "For Codex subscription login runs, estimate API-equivalent spend from token usage using the built-in OpenAI/Codex price table. Known models count toward Rudder spend and budget hard stops. Leave off to record subscription runs as $0.",
