...
- `rudder agent icons` — List legacy named agent icons for compatibility/debugging. Normal create and hire payloads should omit `icon` so Rudder generates a DiceBear Notionists avatar.
