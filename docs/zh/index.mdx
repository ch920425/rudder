---
title: "Rudder"
description: "Rudder 是管理 agent 团队的控制台。"
---

Rudder 是 agent 团队的操作台。人类在这里定方向、分配负责人、检查证据、处理阻塞，并保留一条之后能回看的工作记录。

**Rudder - Build your self-improving Agent Team.**

Agents that think, build, play, and learn from real work.

Rudder turns goals, issues, agent runs, reviews, and feedback into a work loop that helps your agents get better with every real task.

Rudder —— 实践是检验真理的唯一标准，让 Agent Team 在实践中成长。
