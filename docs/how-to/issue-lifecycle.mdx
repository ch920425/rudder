...
description: "A practical Rudder guide for moving AI agent work from chat intake to backlog, todo, assignment, execution, review, evidence, and done."
icon: "route"
keywords:
...
- Engineering agent implements a code change; QA or reviewer agent checks tests, risk, and evidence.
- Docs agent writes public documentation; product reviewer agent checks clarity, positioning, and missing use cases.
- Release agent prepares a version or changelog; release reviewer agent checks commands, artifacts, and rollback risk.
- Data or migration agent produces a plan; safety reviewer agent checks organization scope, irreversible steps, and backup evidence.
...
| Agent-to-agent docs review | Docs agent drafts reviewer guidance but should not self-accept public docs quality | Explain issue reviewer mechanism in public docs | Docs agent | Product/docs reviewer agent | changed docs pages, rendered preview or docs check, reviewer decision |
