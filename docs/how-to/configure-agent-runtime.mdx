...
filesystem or network access. Turn on **Count subscription usage as cost** when
you want ChatGPT/Codex subscription-authenticated runs to appear in Rudder as
...
estimates count toward Rudder spend and budget hard stops.
