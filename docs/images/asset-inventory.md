...
| `agent-runtime-codex-config.png` | New-agent runtime form showing the Codex local runtime type, model, search, sandbox, command, and environment-variable controls. | `docs/how-to/configure-agent-runtime.mdx`, `docs/zh/how-to/configure-agent-runtime.mdx` | Cropped from a mock Runtime Setup Demo org. Keep the primary runtime card readable, including the advanced options area. |
