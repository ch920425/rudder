...
- Hardened release maintenance by cleaning obsolete canary GitHub Releases and tags after stable publish while preserving the active npm canary line.
...
- Added inline chat message editing and tightened mention menus so skill and composer suggestions stay anchored and readable during editing.
...
- Refined Desktop and shell UI details with cross-platform dev startup fixes, Windows-scoped rail sizing, updated rail icons, and tighter workspace launcher presentation.
