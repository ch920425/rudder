...
const AGENT_CLI_CAPABILITIES: AgentCliCapability[] = [
  ...
  },
  {
    ...
    category: "library",
    description: "List Library files and folders; file rows include libraryEntryId when a strong Markdown reference can be generated.",
    mutating: false,
    contract: "agent-v1",
    requiresOrgId: true,
    requiresAgentId: false,
  ...
  },
  {
    ...
    category: "library",
    description: "Fallback read for one Library file when local filesystem access is unavailable; JSON includes mentionHref and markdownLink.",
    mutating: false,
    contract: "agent-v1",
    requiresOrgId: true,
    requiresAgentId: false,
  ...
  },
  {
    ...
    category: "library",
    description: "Fallback create or update for one Library file when local filesystem access is unavailable; JSON includes mentionHref and markdownLink.",
    mutating: true,
    contract: "agent-v1",
    requiresOrgId: true,
    requiresAgentId: false,
  ...
  },
  {
    ...
    category: "library",
    description: "Return the stable Markdown reference for an existing Library file without printing its content.",
    mutating: false,
    contract: "agent-v1",
    requiresOrgId: true,
    requiresAgentId: false,
