...
const AGENT_CLI_CAPABILITIES: AgentCliCapability[] = [
  ...
  },
  {
    ...
    category: "library",
    description: "Read one Library file; JSON output includes mentionHref and markdownLink for strong Library entry references.",
    mutating: false,
    contract: "agent-v1",
    requiresOrgId: true,
    requiresAgentId: false,
  ...
  },
  {
    ...
    category: "library",
    description: "Create or update one Library file; JSON output includes mentionHref and markdownLink for Agent closeout comments.",
    mutating: true,
    contract: "agent-v1",
    requiresOrgId: true,
    requiresAgentId: false,
  ...
  },
  {
    ...
    category: "library",
    description: "Return the strong Markdown link for an existing Library file without printing its content.",
    mutating: false,
    contract: "agent-v1",
    requiresOrgId: true,
    requiresAgentId: false,
